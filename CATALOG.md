...
| `google-cloud` | Google Cloud Platform | dedicated | `africa-south1` (egress), `all` (egress), `asia-east1` (egress), `asia-east2` (egress), `asia-northeast1` (egress), `asia-northeast2` (egress), `asia-northeast3` (egress), `asia-south1` (egress), `asia-south2` (egress), `asia-southeast1` (egress), `asia-southeast2` (egress), `asia-southeast3` (egress), `australia-southeast1` (egress), `australia-southeast2` (egress), `europe-central2` (egress), `europe-north1` (egress), `europe-north2` (egress), `europe-southwest1` (egress), `europe-west10` (egress), `europe-west12` (egress), `europe-west15` (egress), `europe-west1` (egress), `europe-west2` (egress), `europe-west3` (egress), `europe-west4` (egress), `europe-west6` (egress), `europe-west8` (egress), `europe-west9` (egress), `global` (egress), `me-central1` (egress), `me-central2` (egress), `me-west1` (egress), `northamerica-northeast1` (egress), `northamerica-northeast2` (egress), `northamerica-south1` (egress), `southamerica-east1` (egress), `southamerica-west1` (egress), `us-central1` (egress), `us-central2` (egress), `us-east1` (egress), `us-east4` (egress), `us-east5` (egress), `us-east7` (egress), `us-south1` (egress), `us-west1` (egress), `us-west2` (egress), `us-west3` (egress), `us-west4` (egress), `us-west8` (egress) | [official ↗](https://knowledge.workspace.google.com/admin/security/obtain-google-ip-address-ranges) |
...
| Slug | Service | Classification | Purposes | Source |
|---|---|---|---|---|
| `auth0` | Auth0 (Okta CIC) | dedicated | `all` (ingress), `australia` (ingress), `canada` (ingress), `europe` (ingress), `japan` (ingress), `united-kingdom` (ingress), `united-states` (ingress) | [official ↗](https://auth0.com/docs/secure/security-guidance/data-security/allowlist) |
| `duo` | Cisco Duo | dedicated | `mfa-australia` (egress), `mfa-canada` (egress), `mfa-central-europe` (egress), `mfa-eu` (egress), `mfa-india` (egress), `mfa-japan` (egress), `mfa-southeast-asia` (egress), `mfa-uae` (egress), `mfa-uk` (egress), `mfa-us` (egress), `mfa` (egress), `trusted-endpoints` (egress) | [official ↗](https://help.duo.com/s/article/1337) |
